...
using Angelic.ApprovalProcessRule;
using Angelic.ApprovalProcessStep;

namespace Angelic.ApprovalProcess;
...
public class ApprovalProcess
{
    ...
    public ICollection<ApprovalProcessRule.ApprovalProcessRule>? Rules { get; set; }
    
    [JsonProperty("steps", Required = Required.Default, NullValueHandling = NullValueHandling.Ignore)]
    public ICollection<ApprovalProcessStep.ApprovalProcessStep>? Steps { get; set; }
