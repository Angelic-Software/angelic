...
namespace Angelic.Models.Configuration.Integrations.Virima;

[GeneratedCode("NJsonSchema", "14.3.0.0 (NJsonSchema v11.2.0.0 (Newtonsoft.Json v13.0.0.0))")]
public record VirimaDetails
{
    ...
    public bool? OverrideSiteRules { get; set; } 
    ...
    public bool? RelationSync { get; set; } 
    ...
    public string? DeleteStatusName { get; set; } 
