...
using Angelic.ApprovalProcessRuleCriteria;

namespace Angelic.ApprovalProcessRule;
...
public class ApprovalProcessRule
{
    ...
    public ICollection<ApprovalProcessRuleCriteria.ApprovalProcessRuleCriteria>? Criteria { get; set; }
